...
export const PHOTOS: Record<string, string> = {
  "Langage oral": "/LO.svg",
  "Langage écrit": "/LE.svg",
  "Cognition mathématique": "/CM.svg",
  "Neurologie": "/Neurologie.svg",
  "Pratique professionnelle": "/PratiquePro.svg",
  "OMF": "/OMF.svg",
  "Oralité": "/Oralite.svg",
  "Voix": "/Voix.svg",
  "Bégaiement": "/Begaiement.svg",
...
export const DOMAIN_PHOTO_CHOICES = [
  { label: "Langage oral", src: "/LO.svg" },
  { label: "Langage écrit", src: "/LE.svg" },
  { label: "Cognition math.", src: "/CM.svg" },
  { label: "Neurologie", src: "/Neurologie.svg" },
  { label: "Pratique prof.", src: "/PratiquePro.svg" },
  { label: "OMF", src: "/OMF.svg" },
  { label: "Oralité", src: "/Oralite.svg" },
  { label: "Voix", src: "/Voix.svg" },
  { label: "Bégaiement", src: "/Begaiement.svg" },
  { label: "Handicap", src: "/Handicap.svg" },
